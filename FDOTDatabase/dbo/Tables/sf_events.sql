CREATE TABLE [dbo].[sf_events] (
    ...
    CONSTRAINT [pk_sf_events] PRIMARY KEY CLUSTERED ([content_id] ASC)
);


GO
CREATE NONCLUSTERED INDEX [idx_sf_events_org_cnt_id]
    ON [dbo].[sf_events]([original_content_id] ASC);


GO
CREATE NONCLUSTERED INDEX [idx_sf_events]
    ON [dbo].[sf_events]([app_name] ASC);
